...
- 涉及主流程的修改，应优先查看 `sirius_chat/core/engine.py`、`sirius_chat/core/chat_builder.py`、`sirius_chat/core/memory_prompt.py`、`sirius_chat/core/memory_runner.py`、`sirius_chat/core/engagement_pipeline.py`。
