...
5. `sirius_chat/async_engine/core.py` ✨ (P0-003 重构)
6. `sirius_chat/async_engine/prompts.py` ✨
7. `sirius_chat/async_engine/orchestration.py` ✨
8. `sirius_chat/providers/base.py`
9. `sirius_chat/providers/middleware/base.py` ✨
10. `sirius_chat/cli.py`
